...
为确保您的阿里云账号及云资源使用安全，如非必要都应避免直接使用阿里云账号（即主账号）来访问函数计算。推荐的做法是使用RAM身份（即RAM用户和RAM角色）来访问函数计算。
...
- [基本概念](https://help.aliyun.com/zh/ram/terms)
- [使用限制](https://help.aliyun.com/zh/ram/product-overview/limits/)
- [权限策略及示例](https://help.aliyun.com/zh/functioncompute/fc/policies-and-sample-policies)
- [授予函数计算访问其他云服务的权限](https://help.aliyun.com/zh/functioncompute/fc/grant-function-compute-permissions-to-access-other-alibaba-cloud-services)
- [授予事件源访问函数计算的权限](https://help.aliyun.com/zh/functioncompute/fc/grant-an-event-source-permissions-to-access-function-compute-1)
- [通过阿里云账号给RAM用户授权](https://help.aliyun.com/zh/functioncompute/fc/grant-permissions-to-a-ram-user-by-using-an-alibaba-cloud-account-1)
- [通过RAM角色实现跨云账号授权](https://help.aliyun.com/zh/functioncompute/fc/grant-permissions-across-alibaba-cloud-accounts-by-using-ram-roles)
