...
1. 在**函数详情**页，可以在**代码**页签修改函数代码，如果左边的分支显示有调整（图示中①），需要先**部署代码**让修改的代码生效，再单击**测试函数**。
  ...
  ![image](../../../../assets/zh-CN/2513527-001-326824102e.png)
2. 也可以将写好的代码导出备份，也可以重新上传代码进行部署。
  
  ![image](../../../../assets/zh-CN/2513527-002-35edc5d5cd.png)
  
  ![image](../../../../assets/zh-CN/2513527-003-07f257a49c.png)
...
3. 在**函数详情**页面，单击右侧的**复制 ARN**获取目标函数的ARN。
  ...
  ![image](../../../../assets/zh-CN/2513527-004-3db0330af3.png)
